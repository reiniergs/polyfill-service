...
public class JSONConfigLoaderService implements ConfigLoaderService {
     ...
     * @throws Exception
     */
    public static HashMap<String, Object> getConfig(String path) throws Exception {
     ...
     * @throws IOException
     */
    private static HashMap<String, Object> convertJSONConfigToMap(File JsonConfigFile) throws IOException{
